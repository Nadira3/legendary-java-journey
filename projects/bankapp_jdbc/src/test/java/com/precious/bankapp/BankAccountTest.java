...
public class BankAccountTest {
	...
	@BeforeEach
    	public void setUp() {
        	...
        	account = new BankAccount(100.0, "Quentin");
    	}
    	...
    	public void testAccountNumberGeneration() {
    		// Test that account numbers generated are ten-character strings
    		assertAll("account number", 
				() -> assertEquals(10, account.getAccountNumber().length()), // Account number should be ten characters
        			() -> assertTrue(account.getAccountNumber() instanceof String, "The return value should be a String")); // Account number should be of String type
	}
}
